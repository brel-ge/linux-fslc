...
static void __init imx6q_clocks_init(struct device_node *ccm_node)
{
	...
	clk_set_parent(clk[IMX6QDL_CLK_IPU2_DI0_PRE_SEL], clk[IMX6QDL_CLK_PLL3_PFD1_540M]);
	clk_set_parent(clk[IMX6QDL_CLK_IPU2_DI1_PRE_SEL], clk[IMX6QDL_CLK_PLL3_PFD1_540M]);
